...
local CONFIG = {
    ...
    Accent2    = Color3.fromRGB(0, 130, 255),
...
OpenBtn.Text = "⬡"; OpenBtn.TextSize = IsMobile and 20 or 15
...
LogoLbl.Size = UDim2.new(1,0,1,0); LogoLbl.Text = "⬡"; LogoLbl.TextSize = 15
...
spawn(function()
    while LogoBox.Parent do
        ...
        tw(LogoLbl,{TextColor3=Color3.fromRGB(0,220,175)},0.85); task.wait(0.85)
...
function Vibecoded:Tab(name,icon)
    ...
    if not IsMobile then
        ...
        btn.MouseEnter:Connect(function()
            if activeTab and activeTab.btn~=btn then
                ...
                tw(iconL,{TextColor3=Color3.fromRGB(0,200,160)},0.15)
            end
        end)
    ...
    function Tab:Section(title)
        ...
        function Section:Toggle(opts)
            ...
            thumb.BackgroundColor3 = val and CONFIG.Accent or Color3.fromRGB(140,155,175)
            ...
            cz.MouseButton1Click:Connect(function()
                ...
                tw(thumb,{Position=val and UDim2.new(1,-(KS+3),0.5,-KS/2) or UDim2.new(0,3,0.5,-KS/2),
                    BackgroundColor3=val and CONFIG.Accent or Color3.fromRGB(140,155,175)},
        ...
        function Section:Slider(opts)
            ...
            fillGlow.Color = ColorSequence.new({
                ColorSequenceKeypoint.new(0,Color3.fromRGB(0,200,160)),
